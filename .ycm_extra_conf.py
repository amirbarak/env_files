...
BASE_FLAGS = BASE_FLAGS + ["-I./src/jag_msgs/c/", "-I./src/cheetah/pipeline/common/", "-I./src/cheetah/"]

# Add DPDK include paths
RTE_SDK = os.environ.get('RTE_SDK', "~/cheetah/packages/dpdk")
BASE_FLAGS = BASE_FLAGS + ["-I" + root + "/"
                           for root, subdirs, files in os.walk(os.path.join(RTE_SDK, 'lib'))
                           if not re.search('/(arch|bsdapp)/?', root)]
